...
import (
	"github.com/ofrendialsa/neromerce/modules/$MODULE_NAME/service"
	"github.com/ofrendialsa/neromerce/modules/$MODULE_NAME/validation"
...
import (
	"github.com/ofrendialsa/neromerce/modules/$MODULE_NAME/repository"
	"gorm.io/gorm"
)
...
import (
	"github.com/ofrendialsa/neromerce/modules/$MODULE_NAME/controller"
